...
import 'mainpageclient_model.dart';
export 'mainpageclient_model.dart';

class MainpageclientWidget extends StatefulWidget {
  const MainpageclientWidget({super.key});

  static String routeName = 'mainpageclient';
  static String routePath = '/mainpageclient';

  @override
  State<MainpageclientWidget> createState() => _MainpageclientWidgetState();
}
