...
import 'authadmin_model.dart';
export 'authadmin_model.dart';
              ...
              children: [
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'j163k8tc' /* Я согласен (-а) с пользователь... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                ...
                FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (currentUserEmail == 'superadmin@mail.ru') {
                      context.pushNamedAuth(
                          ZayakitestWidget.routeName, context.mounted);
                    } else {
                      context.pushNamedAuth(
